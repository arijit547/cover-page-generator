  ...
  return (
    <>
      ...
      >
        ...
        <span className={isPlaceholder ? styles.placeholder : styles.fieldValue} data-export-placeholder={isPlaceholder || undefined}>{display}</span>
      </p>
...
export default function ModernTemplate({ university, formData, coverType, reorderField }) {
    ...
    <div className={styles.page}>
      ...
      <div className={styles.content}>
        <header className={styles.header}>
          ...
          />
          <div>
            <p className={styles.shortName}>{university.shortName}</p>

...
export default function FormLabReport({ 
  formData, 
  updateField,
  addCustomField,
  updateCustomField,
  ...
  return (
    <form className={styles.form} onSubmit={(e) => e.preventDefault()}>
      <Section title="Course & Experiment">
        ...
        {courseDetailsOrder.includes('experimentNo') && (
          <Field
            label="Experiment No."
            id="experimentNo"
            value={formData.experimentNo}
            onChange={(v) => updateField('experimentNo', v)}
            onRemove={() => removeStandardField('courseDetailsOrder', 'experimentNo')}
            {...getLineProps('experimentNo')}
          />
        )}
        {courseDetailsOrder.includes('experimentName') && (
          <Field
            label="Experiment Name"
            id="experimentName"
            value={formData.experimentName}
            onChange={(v) => updateField('experimentName', v)}
            onRemove={() => removeStandardField('courseDetailsOrder', 'experimentName')}
            {...getLineProps('experimentName')}
          />
        )}

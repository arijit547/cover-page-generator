...
import FormLabReport from '../components/FormLabReport';
  ...
  return (
    <div className={styles.page}>
      <header className={styles.header}>
        <h1 className={styles.title}>Lab Report Cover Page</h1>
        <p className={styles.subtitle}>Fill in experiment and submission details for your lab report cover.</p>
      </header>
